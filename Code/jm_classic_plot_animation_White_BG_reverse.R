...
for (i in 1:80) {
  ggplot(plotdata, aes(time, y)) + facet_wrap(~ group, scales = 'free_y', nrow = 2, strip.position = "right") + 
    ...
    #            size = 4)
    # geom_point(data = plotdata[plotdata$group == "Longitudinal outcome", ][1:15, ], 
    #            aes(x = time, y = y), color = '#1098f7', 
    #            size = sizes[1:15]) + 
    # geom_blank(data = plotdata[plotdata$group == "Longitudinal outcome", ]) + 
    xlim(0, 15) + 
    geom_line(data = new_plotdata[new_plotdata$group == 'Hazard', ][1:i, ], 
  ...
  #              size = 1)
  ggsave(filename = paste0('D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\JMclassic_Haz_', i, '.png'), 
         height = 648, width = 1280, units = 'px')
}

paths <- rep(NA, 80)
for(i in 1:80) {
  paths[i] <- paste0('D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\JMclassic_Haz_',
                     i, '.png')
}

gif_file <- gifski(paths, delay = 0.05, loop = FALSE, width = 1280, height = 648,
                   gif_file = 'D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\animation_haz.gif')
...
for (i in 1:60) {
  ggplot(plotdata, aes(time, y)) + facet_wrap(~ group, scales = 'free_y', nrow = 2, strip.position = "right") + 
    ...
    #            aes(x = time, y = y), fill = '#ea5455', color = '#ea5455', shape = '\U0001f494', 
    #            size = 4)
    geom_point(data = copies[1:i, ], 
               aes(x = time, y = y), color = '#1098f7', 
               size = sizes[1:i]) + 
    geom_blank(data = copies) + 
    xlim(0, 15) + 
  ...
  #              aes(x = time, y = y), color = '#ea5455', shape = '\U0001f494', 
  #              size = 1)
  ggsave(filename = paste0('D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\JMclassic_Haz_', i + 80, '.png'), 
         height = 648, width = 1280, units = 'px')
}
...
gif_file <- gifski(paths, delay = 0.1, loop = FALSE, width = 1280, height = 648,
                   gif_file = 'D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\animation_obs.gif')
...
for (i in 1:80) {
  ggplot(plotdata, aes(time, y)) + facet_wrap(~ group, scales = 'free_y', nrow = 2, strip.position = "right") + 
    ...
    geom_blank(data = new_plotdata[new_plotdata$group == "Hazard", ], 
               aes(x = h_smooth_x, y = h_smooth_y)) + 
    geom_line(data = new_plotdata[new_plotdata$group == 'Longitudinal outcome', ][1:i, ], 
  ...
  #              aes(x = time, y = y), color = '#ea5455', shape = '\U0001f494', 
  #              size = 1)
  ggsave(filename = paste0('D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\JMclassic_Haz_', i + 140, '.png'), 
         height = 648, width = 1280, units = 'px')
}
...
gif_file <- gifski(paths, delay = 0.05, loop = FALSE, width = 1280, height = 648,
                   gif_file = 'D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\animation_long.gif')
...
# }
# 
# gif_file <- gifski(paths, delay = 0.075, loop = FALSE, width = 1280, height = 648, 
#                    gif_file = 'D:\\gpapageorgiou\\myPresentations\\Thesis_Presentation\\Animations\\JM_Classic\\White_BG\\animation_all1.gif')
