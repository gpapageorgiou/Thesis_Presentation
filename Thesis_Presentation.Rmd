...
In both situations we are dealing with a disease which may increase the risk for a negative health related outcome. 
...
As soon as we diagnose the problem, we start to closely follow-up the patients and record longitudinal outcomes that are associated with that risk as they have the potential to help us manage these patients better and prevent negative outcomes for their health.
...
Since we cannot measure risk directly itself, we monitor other markers, repeatedly over time, which can help us estimate it instead. 
...
We therefore use a specific class of statistical models, known as mixed-effects models, to estimate the true underlying subject-specific trajectory as a continuous function of time.  
