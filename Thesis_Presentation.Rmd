...
we end up with 18 association parameters in total making the selection of the association structure challenging.
...
We therefore investigated and proposed the use of Bayesian shrinkage priors as a method to automate and help in the selection of the association structure in this case.

These priors give a penalty to weaker signals, shrinking them towards zero, while stronger signals are not penalized.
